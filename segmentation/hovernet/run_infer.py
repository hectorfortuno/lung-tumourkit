...
def main_with_args(args: Dict, sub_args: Dict, sub_cmd: str) -> None:
    ...
    method_args = {
        ...
        'method' : {
            ...
            # 'stroma_model_path': args['stroma_model_path']
        },
    ...
    if args['model_mode'] == 'fast':
        ...
        if str(args['shape']) == '270':
            run_args['patch_input_shape'] = 270
            run_args['patch_output_shape'] = 80
        elif str(args['shape']) == '518':
            run_args['patch_input_shape'] = 518
            run_args['patch_output_shape'] = 328
        else:
            assert False, 'Wrong shape at inference.'
