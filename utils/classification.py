...
def fit_column_normalizer(
    ...
    """
    X, y = _read_all_nodes(node_dir, [x + '.nodes.csv' for x in names], remove_area=remove_area, remove_perimeter=remove_perimeter, remove_std=remove_std,
...
def metrics_from_predictions(
    ...
    # Multi-class
        ...
        # no_bkgr_cells = np.where(y_true != -1)[0]
        # y_true = y_true[no_bkgr_cells]
        # y_pred = y_pred[no_bkgr_cells]
