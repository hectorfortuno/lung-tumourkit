...
# import sys
# sys.path.append(r"..")
from utils.preprocessing import read_labels, read_labels_idx, parse_path, create_dir, get_names, save_centroids, get_centroid_by_id
...
def main_with_args(args):
    ...
    for name in tqdm(names):
        if args.eval: # For eval read csv without 'id', as it is optimized like this for inference
            img, csv = read_labels(name, png_dir, csv_dir)
        else:
            img, csv = read_labels_idx(name, png_dir, csv_dir)
